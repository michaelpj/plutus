...
checkProgram
    :: (AsNormalizationError e TyName Name a, MonadError e m)
...
typeValue
    :: Type tyname a
    -> Either (NormalizationError tyname name a) (Type tyname a)
typeValue = cataM aM
  where
