...
module Language.PlutusIR.Analysis.Usages
    ( runTermUsages
    , runTypeUsages
    , Usages
    , isUsed
...
runTypeUsages
    :: (PLC.HasUnique (tyname a) PLC.TypeUnique) => Type tyname a -> Usages
...
tyVarDeclUsages :: (MonadState Usages m) => TyVarDecl tyname a -> m ()
