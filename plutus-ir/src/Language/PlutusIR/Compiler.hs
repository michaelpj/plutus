...
import qualified Language.PlutusIR.Compiler.Term
                                               as Term
...
compileProgram
    ...
    -> m (PLC.Program TyName Name (Provenance a))
compileProgram (Program a t) =
    PLC.Program (Original a) (PLC.defaultVersion (Original a)) <$> compileTerm t
