...
newtype Signature =
  Signature
    { getSignature :: Builtins.ByteString
    }
  deriving  (Show, Eq, Ord, Generic)
  deriving newtype (P.Eq, P.Ord, Serialise)
  deriving anyclass (ToSchema)
...
instance ToJSON Signature where
  toJSON signature =
    JSON.object
      [ ( "getSignature"
        , JSON.String . JSON.encodeByteString . BSL.toStrict . getSignature $
          signature)
      ]
...
sign msg (PrivateKey privKey) =
  let k = ED25519.secretKey $ BSL.toStrict $ KB.getLedgerBytes privKey
   ...
   in throwCryptoError $
      fmap convert (ED25519.sign <$> k <*> pure salt <*> pk <*> pure msg)
...
toPublicKey =
  PubKey .
  KB.fromBytes .
  BSL.pack . BA.unpack . ED25519.toPublic . f . KB.bytes . getPrivateKey
  where
...
privateKey1, privateKey2, privateKey3, privateKey4, privateKey5, privateKey6, privateKey7, privateKey8, privateKey9, privateKey10 ::
     PrivateKey
privateKey1 =
...
privateKey5 =
  fromHex "3b26516fb3dc88eb181b9ed73f0bcd52bcd6b4c788e4bcaf46057fd078bee073"

privateKey6 =
  fromHex "edc6f5fbdd1cee4d101c063530a30490b221be68c036f5b07d0f953b745df192"

privateKey7 =
  fromHex "a980f892db13c99a3e8971e965b2ff3d41eafd54093bc9f34d1fd22d84115bb6"

privateKey8 =
  fromHex "9acad959d216212d789a119252ebfe0c96512a23c73bd9f3b202292d6916a738"

privateKey9 =
  fromHex "d5aeee41eeb0e9d1bf8337f939587ebe296161e6bf5209f591ec939e1440c300"

privateKey10 =
  fromHex "0a47d10452ae2febec518a1c7c362890c3fc1a49d34b03b6467d35c904a8362d"
